...
export default function PropertiesPanel({ selectedItem, isPinned, onTogglePin }: PropertiesPanelProps) {
  ...
  return (
    <div className="bg-vault-bg-secondary h-full">
      <div className="px-6 py-4 border-b border-vault-bg-hover">
        <h2 className="text-lg font-semibold text-primary">Properties</h2>
      </div>

      <div className="p-6 bg-vault-bg-primary border-b border-vault-bg-hover">
        {/* Large icon */}
